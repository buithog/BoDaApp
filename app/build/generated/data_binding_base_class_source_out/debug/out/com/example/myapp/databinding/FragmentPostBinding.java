...
public final class FragmentPostBinding implements ViewBinding {
  ...
  private FragmentPostBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerPost) {
  ...
  public static FragmentPostBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPostBinding((LinearLayout) rootView, recyclerPost);
    }
