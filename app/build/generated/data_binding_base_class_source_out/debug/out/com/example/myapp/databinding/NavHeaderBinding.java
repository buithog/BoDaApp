...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView datetime,
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavHeaderBinding((LinearLayout) rootView, datetime, tvEmail, tvFullname);
    }
